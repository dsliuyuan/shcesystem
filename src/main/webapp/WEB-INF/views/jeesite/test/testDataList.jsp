		...
		<c:forEach items="${page.list}" var="testData">
			<tr>
				...
				<shiro:hasPermission name="test:testData:edit"><td>
    				<a href="${ctx}/test/testData/form?id=${testData.id}" class="button btn-modify">修改</a>
					<a href="${ctx}/test/testData/delete?id=${testData.id}" onclick="return confirmx('确认要删除该单表吗？', this.href)" class="button btn-delete">删除</a>
