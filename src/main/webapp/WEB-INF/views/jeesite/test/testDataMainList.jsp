		...
		<c:forEach items="${page.list}" var="testDataMain">
			<tr>
				...
				<shiro:hasPermission name="test:testDataMain:edit"><td>
    				<a href="${ctx}/test/testDataMain/form?id=${testDataMain.id}" class="button btn-modify">修改</a>
					<a href="${ctx}/test/testDataMain/delete?id=${testDataMain.id}" onclick="return confirmx('确认要删除该主子表吗？', this.href)" class="button btn-delete">删除</a>
