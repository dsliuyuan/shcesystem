	...
	<script type="text/template" id="treeTableTpl">
		<tr id="{{row.id}}" pId="{{pid}}">
			...
			<shiro:hasPermission name="test:testTree:edit"><td>
   				<a href="${ctx}/test/testTree/form?id={{row.id}}" class="button btn-modify">修改</a>
				<a href="${ctx}/test/testTree/delete?id={{row.id}}" onclick="return confirmx('确认要删除该树结构及所有子树结构吗？', this.href)" class="button btn-delete">删除</a>
