		...
		<c:forEach items="${page.list}" var="genScheme">
			<tr>
				...
				<shiro:hasPermission name="gen:genScheme:edit"><td>
    				<a href="${ctx}/gen/genScheme/form?id=${genScheme.id}" class="button btn-modify">修改</a>
					<a href="${ctx}/gen/genScheme/delete?id=${genScheme.id}" onclick="return confirmx('确认要删除该生成方案吗？', this.href)" class="button btn-delete">删除</a>
