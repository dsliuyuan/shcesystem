		...
		<c:forEach items="${page.list}" var="genTable">
			<tr>
				...
				<shiro:hasPermission name="gen:genTable:edit"><td>
    				<a href="${ctx}/gen/genTable/form?id=${genTable.id}" class="button btn-modify" class="button btn-modify">修改</a>
					<a href="${ctx}/gen/genTable/delete?id=${genTable.id}" onclick="return confirmx('确认要删除该业务表吗？', this.href)" class="button btn-delete" class="button btn-delete">删除</a>
