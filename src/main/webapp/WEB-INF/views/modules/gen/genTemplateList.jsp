		...
		<c:forEach items="${page.list}" var="genTemplate">
			<tr>
				...
				<shiro:hasPermission name="gen:genTemplate:edit"><td>
    				<a href="${ctx}/gen/genTemplate/form?id=${genTemplate.id}" class="button btn-modify">修改</a>
					<a href="${ctx}/gen/genTemplate/delete?id=${genTemplate.id}" onclick="return confirmx('确认要删除该代码模板吗？', this.href)" class="button btn-delete">删除</a>
