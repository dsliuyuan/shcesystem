...
<body>
	...
	<form:form id="inputForm" modelAttribute="link" action="${ctx}/cms/link/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="cms:link:edit"><button style="margin-right: 20px;" id="btnSubmit" class="btn btn-primary" type="submit" onclick="submitss()"> <i class="icon-save" style="margin-right: 6px;"></i>保 存 </button></shiro:hasPermission>
