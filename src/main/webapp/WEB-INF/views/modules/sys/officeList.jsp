	...
	<script type="text/template" id="treeTableTpl">
		<tr id="{{row.id}}" pId="{{pid}}">
			...
			<shiro:hasPermission name="sys:office:edit"><td>
				<a href="${ctx}/sys/office/form?id={{row.id}}" class="button btn-modify">修改</a>
				<a href="${ctx}/sys/office/form?parent.id={{row.id}}" class="button btn-show3">添加下级机构</a>
				<a href="${ctx}/sys/office/delete?id={{row.id}}" onclick="return confirmx('要删除该机构及所有子机构项吗？', this.href)" class="button btn-delete">删除</a>
