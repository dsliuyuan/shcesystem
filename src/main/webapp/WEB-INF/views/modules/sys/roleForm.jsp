	...
	<form:form id="inputForm" modelAttribute="role" action="${ctx}/sys/role/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<c:if test="${(role.sysData eq fns:getDictValue('是', 'yes_no', '1') && fns:getUser().admin)||!(role.sysData eq fns:getDictValue('是', 'yes_no', '1'))}">
				<shiro:hasPermission name="sys:role:edit"><button style="margin-right: 20px;" id="btnSubmit" class="btn btn-primary" type="submit" onclick="submitss()"> <i class="icon-save" style="margin-right: 6px;"></i>保 存 </button></shiro:hasPermission>
			</c:if>
