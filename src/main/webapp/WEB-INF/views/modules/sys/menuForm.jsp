...
<body>
	...
	<form:form id="inputForm" modelAttribute="menu" action="${ctx}/sys/menu/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="sys:menu:edit"><button style="margin-right: 20px;" id="btnSubmit" class="btn btn-primary" type="submit" onclick="submitss()"> <i class="icon-save" style="margin-right: 6px;"></i>保 存 </button></shiro:hasPermission>
