...
<body>
	...
	<form:form id="inputForm" modelAttribute="oaNotify" action="${ctx}/oa/oaNotify/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<c:if test="${oaNotify.status ne '1'}">
				<shiro:hasPermission name="oa:oaNotify:edit"><button style="margin-right: 20px;" id="btnSubmit" class="btn btn-primary" type="submit" onclick="submitss()"> <i class="icon-save" style="margin-right: 6px;"></i>保 存 </button></shiro:hasPermission>
			</c:if>
