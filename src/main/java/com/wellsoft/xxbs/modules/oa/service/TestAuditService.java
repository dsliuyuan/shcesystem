 ...
 */
package com.wellsoft.xxbs.modules.oa.service;

import java.util.Map;

import com.wellsoft.xxbs.modules.act.service.ActTaskService;
...
import com.wellsoft.xxbs.modules.act.service.ActTaskService;
import com.wellsoft.xxbs.modules.act.utils.ActUtils;
import com.wellsoft.xxbs.modules.oa.entity.TestAudit;
import com.wellsoft.xxbs.modules.oa.dao.TestAuditDao;
...
//			actTaskService.startProcess(ActUtils.PD_TEST_AUDIT[0], ActUtils.PD_TEST_AUDIT[1], testAudit.getId(), testAudit.getContent());
			actTaskService.startProcess("conduct_audit", ActUtils.PD_TEST_AUDIT[1], testAudit.getId(), testAudit.getContent());
